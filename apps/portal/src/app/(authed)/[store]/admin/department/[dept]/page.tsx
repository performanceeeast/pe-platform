...
export const metadata: Metadata = { title: 'Department tasks' };

interface DepartmentTasksPageProps {
  params: { dept: string };
}

export default async function DepartmentTasksPage({ params }: DepartmentTasksPageProps) {
  ...
  return (
    <div className="container max-w-4xl py-4 md:py-8">
      <PageHeader
        title={`${DEPT_LABELS[dept]} — tasks`}
        description={`Open and waiting tasks tagged ${DEPT_LABELS[dept]}.`}
      />

...
export function UserMenu({ email, fullName, roleLabel }: UserMenuProps) {
    ...
    <DropdownMenu>
      <DropdownMenuTrigger asChild>
        <Button variant="ghost" size="icon" aria-label="Open user menu">
          <span className="flex h-8 w-8 items-center justify-center rounded-full bg-store-500 text-xs font-semibold text-white">
            {initials}
          </span>
        </Button>
      </DropdownMenuTrigger>
